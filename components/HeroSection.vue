      ...
      <div class="hero-inner">
        ...
        <div class="hero-left">
          ...
          <div class="hero-cta reveal reveal-delay-3">
            <a href="#pricing" class="btn-primary" id="hero-cta-primary">
              Start Investing
              <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5"><path d="M5 12h14M12 5l7 7-7 7"/></svg>
            </a>
            <a href="#features" class="btn-secondary" id="hero-cta-secondary">
              <svg width="16" height="16" viewBox="0 0 24 24" fill="currentColor"><circle cx="12" cy="12" r="10" opacity="0.2"/><polygon points="10,8 16,12 10,16" fill="currentColor"/></svg>
              See how it works
            </a>
          </div>
          ...
          <div class="phone-wrap">
            ...
            <div class="float-card float-card-tl glass-card">
              ...
              <div>
                ...
                <span class="float-change positive">+3.24%</span>
              </div>
            </div>
            ...
            <div class="float-card float-card-br glass-card">
              ...
              <div>
                ...
                <span class="float-change positive">+2.17%</span>
              </div>
            </div>
            ...
            <div class="phone" role="img" aria-label="Crypto app dashboard">
              ...
              <div class="phone-inner">
                ...
                <div class="phone-actions">
                  <button class="phone-action-btn">
                    <span>↓</span>
                    Receive
                  </button>
                  <button class="phone-action-btn primary">
                    <span>↑</span>
                    Send
                  </button>
                  <button class="phone-action-btn">
...
.phone {
  width: 280px;
  height: 560px;
  background: linear-gradient(160deg, #141424 0%, #0c0c1a 100%);
  border-radius: 40px;
...
.bar:hover { background: rgba(196,255,0,0.4); }
...
.phone-action-btn:hover { background: rgba(255,255,255,0.08); color: var(--text-primary); }
.phone-action-btn.primary { background: var(--accent); color: var(--text-dark); border: none; }
.phone-action-btn.primary:hover { background: #d0ff20; box-shadow: 0 4px 16px rgba(196,255,0,0.4); }
...
.ring-1 {
  ...
  border: 1.5px solid rgba(196,255,0,0.18);
...
.ring-1::before {
  ...
  top: 0; left: 50%;
  transform: translate(-50%, -50%);
  box-shadow: 0 0 16px rgba(196,255,0,0.9);
}
